...
CREATE TABLE TBL_TIPO_JOGO(
	ID_TIPO_JOGO INT NOT NULL PRIMARY KEY IDENTITY,
...
CREATE TABLE TBL_JOGOS(
	...
	ID_TIPO_JOGO INT NULL FOREIGN KEY REFERENCES TBL_TIPO_JOGO(ID_TIPO_JOGO),
	ID_JOGADOR_CAPITAO INT NULL FOREIGN KEY REFERENCES TBL_JOGADOR(ID_JOGADOR),
	EM_CASA BIT NOT NULL,
